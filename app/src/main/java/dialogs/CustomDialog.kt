...
object CustomDialog {
    fun getAlertDialog(context: Context, title: String, content: String, confirmListener: DialogInterface.OnClickListener? = null, cancelListener: DialogInterface.OnClickListener? = null) : AlertDialog{
